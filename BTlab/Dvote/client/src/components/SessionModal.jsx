...
export default function SessionModal({ instance, myAddr }) {
	...
	const createSession = async (event) => {
		...
		let registrationDeadline = Math.floor(
			new Date(event.target.registrationDeadline.value) / 1000
		); //.getSeconds();
		let votingDeadline = Math.floor(
			new Date(event.target.votingDeadline.value) / 1000
		); //.getSeconds();
			...
			<div class="modal">
				...
				>
					...
					>
						<textarea
							class="form-input"
							placeholder="Session General Information "
							name="info"
							type="text"
						></textarea>
						<input
							class="form-input"
							placeholder="maximum voters size"
							name="maxVotersSize"
							type="number"
						></input>
						<input
							class="form-input"
							placeholder="maximum candidate size"
							name="maxCandidateSize"
							type="number"
						></input>
						<input
							class="form-input"
							placeholder="Registration Deadline, Format yyyy-mm-dd hh:mm:ss"
							name="registrationDeadline"
						></input>
						<input
							class="form-input"
							placeholder="Voting Deadline, Format yyyy-mm-dd hh:mm:ss"
							name="votingDeadline"
						></input>
