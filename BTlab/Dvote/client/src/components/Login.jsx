...
export default function Login({ instance, onChange, myAddr, loginOpened }) {
	...
	useEffect(() => {
		instance.events.participantRegistered(
			{ fromBlock: 0, filter: { user: myAddr } },
			(err, evt) => {
					...
					<div class="body">
						<div class="login-container">
							<div class="description-container">
								<p>
									A General Decentralized voting Application that is Open,
									Secure and customizable. Register once so that you could be
									Able to create or participate in open voting Sessions
								</p>
							</div>
